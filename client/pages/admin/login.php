<!-- Admin Login Page - MINSU-Style Design -->
<div class="page-wrapper">
  <div class="auth-card">
    ...
    <div class="auth-header">
      ...
      <p class="auth-subtitle" data-branding="institution"></p>
    </div>
...
<script>
  (function () {
    const loginForm = Utils.$("#adminLoginForm");
    ...
    loginForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (!["admin", "system_admin", "campus_admin", "staff"].includes(user.role)) {
          showError("Access denied. This portal is for admin staff only.");
          Auth.logout();
          return;
        }
