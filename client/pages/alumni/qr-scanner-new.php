...
(function() {
  ...
  async function processCheckin(code) {
    ...
    try {
      ...
      const response = await API.post('/events/checkin', { code: code });
      ...
      document.getElementById('successPoints').textContent = `+${data.points_earned || 20}`;
      ...
      resumeTimer = setTimeout(async () => {
        if (!isDestroyed && html5QrCode && html5QrCode.getState() === 2) {
